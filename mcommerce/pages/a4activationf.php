...
<div class="text-center">
    <span class="icon bg-white icon-lg rounded-circle rotate"><i class="fa text-warning fa-exclamation-triangle"></i></span>
</div>
<p class="text-center">
Dear Francis. <br>
<strong>Your account on "Udox Shopping Mall" not Activated your verification code expired</strong>
</p>


<p class="text-center"> <a href="a1mlogin.php" class="btn-link"></i><i class="fas fa-redo"></i> Send agin</a>
</p>
