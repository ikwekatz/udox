...
<div class="text-center">
    <span class="icon bg-white icon-lg rounded-circle rotate" style="background-image:url('../asset/images/1.jpg'); background-size: cover;"></span>
</div>
<p class="text-center">
Congratulation Francis. <br>
<strong>Your account on "Udox Shopping Mall" has now been Activated you may login using your email and password</strong>
</p>


<p class="text-center"> <a href="a1mlogin.php" class="btn-link"></i><i class="fas fa-sign-in-alt"></i> login now</a>
</p>
