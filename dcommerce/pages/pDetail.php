...
<article class="gallery-wrap"> 
	<div class="img-big-wrap">
	  <div> <a href="#"><img src="<?php echo image.'/3.jpg'?>"></a></div>
	</div> <!-- slider-product.// -->
	<div class="thumbs-wrap">
	  <a href="#" class="item-thumb"> <img src="<?php echo image.'/3.jpg'?>"></a>
	  <a href="#" class="item-thumb"> <img src="<?php echo image.'/3.jpg'?>"></a>
	  <a href="#" class="item-thumb"> <img src="<?php echo image.'/3.jpg'?>"></a>
	  <a href="#" class="item-thumb"> <img src="<?php echo image.'/3.jpg'?>"></a>
	</div> <!-- slider-nav.// -->
...
<div class="row">
    ...
    <article class="media mb-3">
      <a href="#"><img src="<?php echo image.'/3.jpg'?>"></a>
    ...
    <article class="media mb-3">
      <a href="#"><img src="<?php echo image.'/2.jpg'?>"></a>
      <div class="media-body">
    ...
    <article class="media mb-3">
      <a href="#"><img src="<?php echo image.'/1.jpg'?>"></a>
      <div class="media-body">
        <h6 class="mt-0"><a href="#">New tips and tricks</a></h6>
        <p class="mb-2"> Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin </p>
      </div>
