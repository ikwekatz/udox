			...
			<div class="row">
				<div class="col-md-8">
					<div class="panel-group checkout-steps" id="accordion">
						<!-- checkout-step-01  -->
<div class="card card-default checkout-step-01">
...
<div class="form-group">
					    ...
					    <input type="text" class="form-control unicase-form-control text-input" value="mboya" id="name" name="name" required="required">
					  </div>
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="francis@gmail.com" readonly>
					  </div>
					  <div class="form-group">
					    <label class="info-title" for="Contact No.">Contact No. <span>*</span></label>
					    <input type="text" class="form-control unicase-form-control text-input" id="contactno" name="contactno" required="required" value="071545456"  maxlength="10">
					  </div>
...
<!-- checkout-step-01  -->
					    <!-- checkout-step-02  -->
					  	<div class="card card-default checkout-step-02">
						    <div class="card-header">
						      <h4 class="unicase-checkout-title">
