...
<div id="carousel1_indicator" class="slider-home-banner carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="<?php echo banners.'slide1.jpg'?>" alt="First slide"> 
    </div>
    <div class="carousel-item">
      <img src="<?php echo banners.'slide2.jpg'?>" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img src="<?php echo banners.'slide3.jpg'?>" alt="Third slide">
    </div>
  </div>
	...
	<div class="col-md d-none d-lg-block flex-grow-1">
		<aside class="special-home-right">
			...
			<div class="card-banner border-bottom">
			  ...
			  <img src="<?php echo  items.'1.jpg'?>" height="80" class="img-bg">
			</div>
			...
			<div class="card-banner border-bottom">
			  ...
			  <img src="<?php echo  items.'2.jpg'?>" height="80" class="img-bg">
			</div>
			...
			<div class="card-banner border-bottom">
			  ...
			  <img src="<?php echo  items.'6.jpg'?>" height="80" class="img-bg">
			</div>
...
<div class="row no-gutters">
	...
	<div class="home-category-banner bg-light-orange">
		...
		<img src="<?php echo  items.'2.jpg'?>" class="img-bg">
	</div>
...
<a href="#" class="item"> 
	<div class="card-body">
		...
		<img class="img-sm float-right" src="<?php echo  items.'1.jpg'?>"> 
...
<a href="#" class="item"> 
	<div class="card-body">
		...
		<img class="img-sm float-right" src="<?php echo  items.'2.jpg'?>"> 
...
<a href="#" class="item"> 
	<div class="card-body">
		...
		<img class="img-sm float-right" src="<?php echo  items.'3.jpg'?>"> 
...
<a href="#" class="item"> 
	<div class="card-body">
		...
		<img class="img-sm float-right" src="<?php echo  items.'4.jpg'?>"> 
...
<a href="#" class="item"> 
	<div class="card-body">
		<h6 class="title">Home and kitchen electronic  stuff collection  </h6>
		<img class="img-sm float-right" src="<?php echo  items.'5.jpg'?>"> 
...
<a href="#" class="item"> 
	<div class="card-body">
		<h6 class="title">Home and kitchen electronic  stuff collection  </h6>
		<img class="img-sm float-right" src="<?php echo  items.'6.jpg'?>"> 
		<p class="text-muted"><i class="fa fa-map-marker-alt"></i> Guanjou, China</p>
	</div>
</a>
	</li>
...
<a href="#" class="item"> 
	<div class="card-body">
		...
		<img class="img-sm float-right" src="<?php echo  items.'7.jpg'?>"> 
...
<div class="row no-gutters">
	...
	<div class="home-category-banner bg-light-orange">
		...
		<p>Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
		<a href="#" class="btn btn-outline-primary rounded-pill">Source now</a>
		<img src="<?php echo  items.'14.jpg'?>" class="img-bg">
	</div>
...
<a href="#" class="item"> 
	<div class="card-body">
		...
		<img class="img-sm float-right" src="<?php echo  items.'8.jpg'?>"> 
		<p class="text-muted"><i class="fa fa-map-marker-alt"></i> Hong Kong, China</p>
	</div>
</a>
	</li>
...
<a href="#" class="item"> 
	<div class="card-body">
		<h6 class="title">Home and kitchen electronic  stuff collection  </h6>
		<img class="img-sm float-right" src="<?php echo  items.'9.jpg'?>"> 
		<p class="text-muted"><i class="fa fa-map-marker-alt"></i> Tashkent, Uzb</p>
	</div>
</a>
	</li>
...
<a href="#" class="item"> 
	<div class="card-body">
		...
		<img class="img-sm float-right" src="<?php echo  items.'10.jpg'?>"> 
		<p class="text-muted"><i class="fa fa-map-marker-alt"></i> Guanjou, China</p>
	</div>
</a>	
	</li>
...
<a href="#" class="item"> 
	<div class="card-body">
		<h6 class="title">Home and kitchen electronic  stuff collection  </h6>
		<img class="img-sm float-right" src="<?php echo  items.'11.jpg'?>"> 
		<p class="text-muted"><i class="fa fa-map-marker-alt"></i> Guanjou, China</p>
	</div>
</a>
	</li>
...
<a href="#" class="item"> 
	<div class="card-body">
		<h6 class="title">Home and kitchen electronic  stuff collection  </h6>
		<img class="img-sm float-right" src="<?php echo  items.'12.jpg'?>"> 
		<p class="text-muted"><i class="fa fa-map-marker-alt"></i> Guanjou, China</p>
	</div>
</a>
	</li>
...
<div class="row row-sm">
	<div class="col-xl-2 col-lg-3 col-md-4 col-6">
		<div class="card card-sm card-product-grid">
			<a href="#" class="img-wrap"> <img src="<?php echo items.'1.jpg'?>"> </a>
	...
	<div class="col-xl-2 col-lg-3 col-md-4 col-6">
		<div class="card card-sm card-product-grid">
			<a href="#" class="img-wrap"> <img src=<?php echo items.'2.jpg'?>> </a>
			<figcaption class="info-wrap">
	...
	<div class="col-xl-2 col-lg-3 col-md-4 col-6">
		<div class="card card-sm card-product-grid">
			<a href="#" class="img-wrap"> <img src=<?php echo items.'3.jpg'?>> </a>
			<figcaption class="info-wrap">
	...
	<div class="col-xl-2 col-lg-3 col-md-4 col-6">
		<div class="card card-sm card-product-grid">
			<a href="#" class="img-wrap"> <img src=<?php echo items.'4.jpg'?>> </a>
			<figcaption class="info-wrap">
				<a href="#" class="title">Just another product name</a>
				<div class="price mt-1">$179.00</div> <!-- price-wrap.// -->
			</figcaption>
	...
	<div class="col-xl-2 col-lg-3 col-md-4 col-6">
		<div class="card card-sm card-product-grid">
			<a href="#" class="img-wrap"> <img src=<?php echo items.'5.jpg'?>> </a>
			<figcaption class="info-wrap">
				<a href="#" class="title">Just another product name</a>
				<div class="price mt-1">$179.00</div> <!-- price-wrap.// -->
			</figcaption>
	...
	<div class="col-xl-2 col-lg-3 col-md-4 col-6">
		<div class="card card-sm card-product-grid">
			<a href="#" class="img-wrap"> <img src=<?php echo items.'6.jpg'?>> </a>
			<figcaption class="info-wrap">
				<a href="#" class="title">Some item name here</a>
				<div class="price mt-1">$280.00</div> <!-- price-wrap.// -->
			</figcaption>
	...
	<div class="col-xl-2 col-lg-3 col-md-4 col-6">
		<div class="card card-sm card-product-grid">
			<a href="#" class="img-wrap"> <img src=<?php echo items.'7.jpg'?>> </a>
			<figcaption class="info-wrap">
				<a href="#" class="title">Great product name here</a>
				<div class="price mt-1">$56.00</div> <!-- price-wrap.// -->
			</figcaption>
	...
	<div class="col-xl-2 col-lg-3 col-md-4 col-6">
		<div class="card card-sm card-product-grid">
			<a href="#" class="img-wrap"> <img src=<?php echo items.'9.jpg'?>> </a>
			<figcaption class="info-wrap">
				<a href="#" class="title">Just another product name</a>
				<div class="price mt-1">$179.00</div> <!-- price-wrap.// -->
			</figcaption>
...
<div class="row">
	<div class="col-md-3 col-sm-6">
		<article class="card card-post">
		  <img src="<?php echo image.'/1.jpg'?>" class="card-img-top">
		  <div class="card-body">
	...
	<div class="col-md-3 col-sm-6">
		<article class="card card-post">
		  <img src=<?php echo image.'/3.jpg'?> class="card-img-top">
		  <div class="card-body">
	...
	<div class="col-md-3 col-sm-6">
		<article class="card card-post">
		  <img src=<?php echo image.'/2.jpg'?> class="card-img-top">
		  <div class="card-body">
...
<article class="my-4">
	<img src=<?php echo items.'ad-sm.png'?> class="w-100">
</article>
</div>  
<!-- container end.// -->
