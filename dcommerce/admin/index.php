<?php include('./includes/header.php')?>
  <body class="az-body ">
    <div class="az-iconbar az-iconbar-primary">
      <a href="index.html" class="az-iconbar-logo"><i class="typcn typcn-chart-bar-outline"></i></a>
      <nav class="nav">
    ...
    <div class="az-iconbar-aside az-iconbar-aside-primary bg-light" >
      <div class="az-iconbar-header">
        <a href="index.html" class="az-logo"> <img src="<?php echo assets.'images/logo.jpg'?>" alt=""></a>
      ...
      <div class="az-iconbar-body bg-primary">
        <div id="asideDashboard" class="az-iconbar-pane">
          ...
          <ul class="nav">
            <li class="nav-item"><a href="dashboard-one.html" class="nav-link">Web Analytics</a></li>
            <li class="nav-item"><a href="dashboard-two.html" class="nav-link">Sales Monitoring</a></li>
            <li class="nav-item"><a href="dashboard-three.html" class="nav-link">Ad Campaign</a></li>
            <li class="nav-item"><a href="dashboard-four.html" class="nav-link">Event Management</a></li>
            <li class="nav-item"><a href="dashboard-five.html" class="nav-link">Helpdesk Management</a></li>
            <li class="nav-item"><a href="dashboard-six.html" class="nav-link">Finance Monitoring</a></li>
