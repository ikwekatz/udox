...
<!-- Mirrored from www.bootstrapdash.com/demo/azia/v1.0.0/template/dashboard-ten.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Sep 2021 22:54:43 GMT -->
<?php
define("assets", '/udox/dcommerce/asset/');
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo assets.'assets/fonts/font-awesome.min.css'?>">
    <link rel="stylesheet" href="<?php echo assets.'ionicons.ttf'?>">
    <link href="<?php echo assets.'assets/css/styles.css' ?>" rel="stylesheet">

    <link href="https://www.bootstrapdash.com/demo/azia/v1.0.0/lib/flag-icon-css/css/flag-icon.min.css"
        rel="stylesheet">
...
<script src="<?php echo assets.'assets/js/az.js'?>"> </script>
<script src="<?php echo assets.'assets/js/jquery.min.js'?>"> </script>
<script src="<?php echo assets.'assets/js/bbundle.js'?>"> </script>
...
<script src="https://www.bootstrapdash.com/demo/azia/v1.0.0/lib/jquery.flot/jquery.flot.categories.js"></script>
<script src="https://www.bootstrapdash.com/demo/azia/v1.0.0/lib/jquery.flot/jquery.flot.resize.js"></script>
<script src="https://www.bootstrapdash.com/demo/azia/v1.0.0/lib/flot.curvedlines/curvedLines.js"></script>
<script src="https://www.bootstrapdash.com/demo/azia/v1.0.0/js/jquery.cookie.js" type="text/javascript"></script>
